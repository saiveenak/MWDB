...
InputPath = fullfile(InputDir,'in_file_d.spca');             
...
iter = 1;
celliter1 = 1;
length1=size(Matrix1);
Newmatrix1 = zeros((FrameRange(2)- FrameRange(1)+1),length1(2));
...
iter = 1;
celliter2 = 1;
Newmatrix2 = zeros((InputMatrix(countV2,2))*InputMatrix(countV2,3),length1(2));
